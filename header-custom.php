...
<title>DETCH motorcycle（デッチモーターサイクル、でっちもーたーさいくる）の &raquo; <?php the_title(); ?></title>
<meta name="description" content="DETCH motorcycle（デッチモーターサイクル、でっちもーたーさいくる）の<?php the_title(); ?>カスタム事例になります">
