...
<title>DETCH motorcycle（デッチモーターサイクル、でっちもーたーさいくる） &raquo; 製品一覧 &raquo; <?php the_title(); ?></title>
<meta name="description" content="DETCH motorcycle（デッチモーターサイクル、でっちもーたーさいくる）、<?php the_title(); ?>">
